...
```bash
npx degit arve0/code-lessons-template my-app
```
...
Source code of lessons in markdown. Are built to `.svelte`-files with [src/build-lessons.js](src/build-lessons.js).
