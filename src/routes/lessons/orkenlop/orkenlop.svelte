<!-- generated from src/lessons/orkenlop/orkenlop.md -->

<svelte:head>
  <title>Ørkenløp</title>
</svelte:head>

<section class="intro">
  <h1 class="intro" id="introduksjon">Introduksjon</h1>
  <p>
    Dette er et spill for to, der en papegøye og en løvinne kjemper om å komme
    først gjennom ørkenen. Hver spiller må trykke en tast så fort og ofte som
    mulig for å flytte figuren sin, og den som kommer først til kanten av
    skjermen vinner.
  </p>
  <figure>
    <img
      src="lessons/orkenlop/orkenlop.png"
      alt="Illustrasjon av et ferdig ørkenløp spill"
    />
  </figure>
</section>
<section class="activity">
  <h1 class="activity" id="steg-1%3A-lag-en-scene-og-legg-til-figurer">
    Steg 1: Lag en scene og legg til figurer
  </h1>
  <p><em>Vi begynner med å få på plass bakgrunnen og figurene.</em></p>
  <section class="check">
...
<section class="activity">
  <h1
    class="activity"
    id="steg-2%3A-la-l%C3%B8vinnen-og-papeg%C3%B8yen-bevege-seg"
  >
    Steg 2: La løvinnen og papegøyen bevege seg
  </h1>
  <p><em>Vi vil at figurene skal bevege seg når du trykker på en knapp.</em></p>
  <section class="check">
    ...
    <ul>
      <li>
        ...
        <pre><code class="blocks">når [l v] trykkes
gå (4) steg
</code></pre>
      </li>
      <li>
...
<section class="activity">
  <h1 class="activity" id="steg-3%3A-start-kappl%C3%B8pet">
...
skjul
  ...
  <section class="flag">
    ...
    <p>
      <strong>Klikk på det grønne flagget, og deretter på startknappen.</strong>
    </p>
    <ul>
      <li>
    ...
    <p>
      Vi ønsker at figurene bare beveger seg etter at kappløpet er startet og vi
...
sett [kappløp v] til [0]
      ...
      <li>
        <p>
          ...
          <code class="blocklooks">si 1 i 1 sekunder</code> i skriptet som
          starter med
          <code class="blockevents">når denne figuren klikkes</code>.
        </p>
      </li>
      <li>
        <p>
...
<section class="activity">
  <h1 class="activity" id="steg-4%3A-avslutte-kappl%C3%B8pet">
    Steg 4: Avslutte kappløpet
  </h1>
  <p>
    <em
      >Nå vil vi finne ut hvem som vinner kappløpet, og i tillegg gjøre klart
      for en ny runde.</em
    >
  </p>
  <section class="check">
...
slutt
      ...
      <li>
        ...
        <p>
          ...
          rundingen slik at den blir rød. Klikk stopp (firkanten) når du er
          ferdig, og gi lyden et navn – for eksempel <code>Polly</code>. Noen
          nettlesere kan spørre om tillatelse til å spille inn lyd. Hvis du ikke
          ønsker dette, bruk lydene som følger med figurene.
        </p>
      </li>
      <li>
        <p>
...
<section class="activity">
  <h1 class="activity" id="steg-5%3A-nullstill-spillet">
    Steg 5: Nullstill spillet
  </h1>
  <p>
    <em
      >Når kappløpet er over må vi fortelle de andre figurene at spillet er over
      og nullstille spillet, slik at er klart for en ny runde.</em
    >
  </p>
  <section class="check">
...
vis
  ...
  <section class="save">
    ...
    <p>
      Spillet er ferdig! Hvis du vil kan du velge <code>Legg ut</code> slik at
      venner og familie også kan spille det.
    </p>
    <p>
      Nedenfor er det noen forslag og ideer til hvordan du kan utvide spillet og
      gjøre det enda mer interessant.
    </p>
  </section>
  <section class="challenge">
    <h2 class="challenge" id="utfordring-1%3A-legg-til-en-rakett!">
    ...
    <p>
      Nedenfor er et forslag til hvordan et rakett-skript kan se ut. Du må legge
      til noen lyder og variabler på egen hånd.
    </p>
    <pre><code class="blocks">når [q v] trykkes
...
slutt
  ...
  <section class="challenge">
    <h2
      class="challenge"
      id="utfordring-2%3A-bruk-egendefinerte-klosser-for-%C3%A5-forenkle-skriptet-ditt"
    >
      Utfordring 2: Bruk egendefinerte klosser for å forenkle skriptet ditt
    </h2>
    <p>
      Koden som brukes til å sjekke om kappløpet er over brukes nå to steder for
      hver figur; når figuren beveger seg normalt og når den beveger seg med
      rakett. Vi kan forenkle skriptet vårt ved å bruke en egendefinert kloss.
      Dette er en samling kode som brukes flere steder. Det er nesten som at vi
      lager vår egen Scratch-kodekloss!
    </p>
    <ul>
      <li>
      ...
      <li>
        ...
        <pre><code class="blocks">definer ferdig
hvis &lt;berører [kant v]?&gt;
    sett [kappløp v] til [0]
    start lyden [Polly v]
    si [Polly vinner! v] i (3) sekunder
...
hvis &lt;&lt;(kappløp) = [1]&gt; og &lt;(rakett_brukt) = [0]&gt;&gt;
  ...
  <section class="flag">
    ...
    <ul>
      <li>
        <p>Virker spillet fortsatt slik det skal?</p>
      </li>
      <li>
        <p>
  ...
  <section class="save">
    ...
    <p>Veldig bra! Nå er du ferdig og kan kose deg med spillet du har laget!</p>
  </section>
</section>
