...
<section class="intro">
  ...
  <p>
    Vi skal nå lage et JafseFisk-spill! Målet i spillet er å hjelpe JafseFisk
    med å spise alle byttedyrene som svømmer rundt i havet.
  </p>
  <figure>
    <img
      src="lessons/jafsefisk/jafsefisk.png"
      alt="Illustrasjon av et ferdig JafseFisk spill"
    />
  </figure>
</section>
<section class="activity">
  <h1 class="activity" id="steg-1%3A-jafsefisk-f%C3%B8lger-musepekeren">
    Steg 1: JafseFisk følger musepekeren
  </h1>
  <p><em>Først skal vi lage JafseFisk som svømmer rundt i havet!</em></p>
  <section class="check">
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          />
          nederst til høyre på skjermen . Velg bakgrunnen
          <code>Natur/underwater2</code>.
        </p>
      </li>
      <li>
        <p>
          ...
          <img
            ...
            alt="Velg draktfra biblioteket"
          />. Gi figuren navnet <code>Jafsefisk</code>.
        </p>
      </li>
      <li>
        <p>
...
<section class="activity">
  <h1 class="activity" id="steg-2%3A-legg-til-byttedyr">
    Steg 2: Legg til byttedyr
  </h1>
  <p><em>Det er på tide å gi JafseFisk noe å spise!</em></p>
  <section class="check">
...
slutt
  ...
  <section class="flag">
    ...
    <p>
      <em
        >For øyeblikket samspiller ikke JafseFisk og byttedyret med hverandre.
        Det skal vi gjøre noe med i neste steg.</em
      >
    </p>
  </section>
  <section class="challenge">
...
<section class="activity">
  <h1 class="activity" id="steg-3%3A-jafsefisk-spiser-byttet">
    Steg 3: JafseFisk spiser byttet
  </h1>
  <p><em>Nå skal vi la JafseFisk spise byttet!</em></p>
  <p>
    Når JafseFisk har fanget byttet i munnen skal to ting skje: JafseFisk må
    lukke munnen og lage en gomlelyd. Videre må byttet forsvinne, for så å dukke
    opp igjen en liten stund senere.
  </p>
  <section class="check">
  ...
  <section class="check">
    ...
    <p>
      <em
        ...
        JafseFisks munn? Tja, vi kan bruke
        <code class="b">&lt;berører fargen [#FFFFFF]?&gt;</code> og se om den
        berører det hvite på fiskens tenner.</em
      >
    </p>
    <ul>
      <li>
      ...
      <li>
        <p>
          ...
          >
          som vi gir tilfeldige verdier for <code>x</code> og <code>y</code>.
        </p>
      </li>
    </ul>
    <p>Slik skal skriptet til byttedyret se ut:</p>
    <pre><code class="blocks">når grønt flagg klikkes
vis
gjenta for alltid
    gå (2) steg
...
<section class="activity">
  <h1 class="activity" id="steg-4%3A-jafsefisk-reagerer">
    Steg 4: JafseFisk reagerer
  </h1>
  <p>
    <em
      >JafseFisk må vite når den har spist noe slik at den kan gi fra seg en lyd
      og bytte drakt.</em
    >
  </p>
  <section class="check">
...
slutt
    ...
    <p>
      Nå vil vi at JafseFisk reagerer på denne meldingen ved å lage en gomlelyd
      og klikke med kjevene.
    </p>
    <ul>
      <li>
        <p>
          ...
          litt og så bytter tilbake.
        </p>
        <pre><code class="blocks">når jeg mottar [Du tok meg! v]
start lyden [bite v]
gjenta (2) ganger
...
slutt
  ...
  <section class="protip">
    <h2 class="protip" id="noe-%C3%A5-tenke-p%C3%A5">Noe å tenke på</h2>
    <p>
      Hvorfor bør vi legge til <code class="b">vis</code> i starten av
  ...
  <section class="save">
    ...
    <p>
      <strong>Godt gjort!</strong> Du har i grunn fullført spillet! Men det
      finnes flere muligheter for utvidelse av spillet. Er du klar for en
      utfordring?
    </p>
  </section>
  <section class="challenge">
    <h2
      class="challenge"
      id="utfordring-1%3A-forandre-bevegelsene-til-byttedyrene"
    >
      Utfordring 1: Forandre bevegelsene til byttedyrene
    </h2>
    <p>
      For øyeblikket beveger alle byttedyrene seg likt.
      <strong>Kan du få ett av dem til å bevege seg annerledes?</strong>
    </p>
    <p>
      <strong>Hint:</strong> Ikke bruke for lang tid på denne oppgaven uten å se
      på de andre utfordringene i dette prosjektet.
    </p>
    <p>
      <strong>Velg deg ut et byttedyr å eksperimentere med.</strong> Hvis de har
      samme drakt, bytt farge med
      <code class="b">sett [farge v] effekt til (0)</code>. Slik kan du se
      forskjell fra resten av byttedyrene. Prøv nå å få dette byttedyret til å
      bevege seg saktere enn de andre.
    </p>
    <p>
      <strong>Hint:</strong> Se på klossen <code class="b">gå (2) steg</code>.
    </p>
  </section>
  <section class="flag">
    ...
    <ul>
      ...
      <li>
        ...
        <p>
          ...
          verdiene i
          <code class="b"
            >snu @turnLeft (tilfeldig tall fra (-20) til (20)) grader</code
          >.
        </p>
      </li>
      <li>
  ...
  <section class="challenge">
    <h2
      class="challenge"
      id="utfordring-2%3A-hjelp-byttet-%C3%A5-unng%C3%A5-jafsefisk"
    >
      Utfordring 2: Hjelp byttet å unngå JafseFisk
    </h2>
    <p>
      Byttedyrene i dette spillet er skikkelig dumme! De svømmer bare tilfeldig
      rundt til de blir spist. Ekte fisk svømmer vekk fra rovfisker. Nå vil vi
      <strong>la ett av byttedyrene svømme vekk fra JafseFisk.</strong>
    </p>
    <p>
      Det fins ingen kloss i Scratch som kan gi oss retningen vekk fra en annen
      figur. Men du kan få en figur til å snu seg i retningen mot en annen, og
      deretter la den snu seg i motsatt retning. Klossene du trenger er i
      <code class="blockmotion">Bevegelse</code>-kategorien.
    </p>
    <p>
      Prøv nå å hjelpe et av byttedyrene med å
      <strong>snu seg vekk fra JafseFisk</strong>. La den også virre litt mens
      den svømmer bort! Du vil kanskje oppdage at byttet setter seg fast i et
      hjørne? Du vil kanskje at byttet bare ønsker å flykte dersom JafseFisk
      kommer for nære? <strong>Hint:</strong> Se tilbake på hvordan vi brukte
      <code class="b">(avstand til [musepeker v])</code> tidligere i spillet.
    </p>
  </section>
  <section class="flag">
  ...
  <section class="challenge">
    <h2 class="challenge" id="utfordring-3%3A-legg-til-poeng">
      Utfordring 3: Legg til poeng
    </h2>
    <p>
      Det er ikke nok bare å spise fisk. Hvordan vet du at du er en bedre
      spiller enn vennene dine? Du må kunne <strong>samle poeng</strong>, så la
      oss legge til <strong>en poengtavle.</strong> Lag en variabel som heter
      <code class="b">(poeng)</code>, og endre denne når JafseFisk spiser. Pass
      på at poengene går tilbake til null ved begynnelsen av spillet. Hvor skal
  ...
  <section class="challenge">
    <h2 class="challenge" id="utfordring-4%3A-legg-til-en-nedtelling">
      Utfordring 4: Legg til en nedtelling
    </h2>
    <p>
      Gi deg selv <strong>en tidsfrist</strong>. Hvor mange fisk kan du spise på
      30 sekunder?
    </p>
    <p>
      Legg til en ny variabel, <code class="b">(tid)</code>. Lag et nytt skript
      som setter variabelen til for eksempel <code>30</code>, for deretter å
      endre denne med <code>-1</code>, vente 1 sekund, og endre igjen, helt til
      den når null. Til slutt kan du bruke en
      <code class="b">stop [alle v]</code>-kloss for å slutte spillet.
    </p>
  </section>
  <section class="flag">
  ...
  <section class="challenge">
    <h2 class="challenge" id="utfordring-5%3A-legg-til-bonuspoeng">
    ...
    <p>
      <strong>Hint:</strong> En måte å gjøre dette på er å bruke en variabel for
      å <strong>telle</strong> hvor mange byttedyr som svømmer i havet.
    </p>
  </section>
  <section class="flag">
  ...
  <section class="challenge">
    <h2
      class="challenge"
      id="utfordring-6%3A-forandre-spillet%3A-hold-byttedyrene-i-live!"
    >
      Utfordring 6: Forandre spillet: Hold byttedyrene i live!
    </h2>
    <p>
      Av og til kan man få glimrende nye idèer ved å gjøre det motsatte av det
      man allerede har gjort.
    </p>
    <p>
      Endre spillet slik at du i stedet
      <strong>kontrollerer et byttedyr</strong> i et hav av
      <strong>mange JafseFisker</strong>. Hvor lenge kan du holde det gående før
      du blir spist? I stedet for å bruke poeng kan du telle liv. Hva med å gi
      byttedyret 3 liv og avslutte spillet når de er brukt opp?
    </p>
  </section>
  <section class="save">
    <h2 class="save" id="lagre-prosjektet-2">Lagre prosjektet</h2>
    <p>
      <strong>Godt gjort, du er ferdig! Nå kan du nyte spillet ditt!</strong>
    </p>
    <p>
      Ikke glem at du kan dele spillet med alle vennene og familien din ved å
      klikke på <code>Legg ut</code> i topp-menyen!
    </p>
  </section>
</section>
