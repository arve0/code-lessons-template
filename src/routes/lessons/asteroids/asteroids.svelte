<!-- generated from src/lessons/asteroids/asteroids.md -->
...
<section class="intro">
  ...
  <p>
    På slutten av 1970-tallet ga Atari ut to spill hvor man skulle kontrollere
    et romskip. Det første var Lunar Lander, men dette ble utkonkurrert av
    Asteroids som Atari ga ut noen måneder senere. Spillene var faktisk så like
    at de kunne gjenbruke mye av teknologien. Vi skal gjøre det samme! Du må
    derfor ha laget
    <a href="lessons/asteroids/../lunar_lander/lunar_lander.html"
      >Lunar Lander</a
    >
    før du begynner på dette prosjektet. I Asteroids er målet å beskytte
    romskipet mot asteroider ved å skyte dem i småbiter.
  </p>
  <figure>
    <img
      src="lessons/asteroids/asteroids.png"
      alt="Illustrasjon av et ferdig astroide spill"
    />
  </figure>
</section>
<section class="activity">
  ...
  <p>
    <em
      >Mesteparten av kodingen av Asteroids skal du gjøre selv (og noe har du
      allerede gjort). I Asteroids vil vi spesielt se på noen av måtene man kan
      gjenbruke kode i Scratch.</em
    >
  </p>
  <section class="check">
...
<section class="activity">
  <h1 class="activity" id="steg-1%3A-enda-et-flyvende-romskip">
  ...
  <p>
    <em
      ...
      <a href="lessons/asteroids/../lunar_lander/lunar_lander.html"
        >Lunar Lander</a
      >
      laget vi et flott romskip. Nå skal vi se hvordan vi kan bruke det samme
      romskipet i dette prosjektet.</em
    >
  </p>
  <p>
    Du vet sikkert at du kan <em>Remikse</em> andres Scratch-prosjekter. Du får
  ...
  <p>
    Nå skal vi se på et triks for å gjenbruke kode vi selv har laget tidligere.
    Ved å bruke <code>Ryggsekken</code> kan man kopiere figurer og kode mellom
    forskjellige prosjekter. Vi vil derfor først kopiere romskipet vi laget i
    Lunar Lander.
  </p>
  <section class="check">
    ...
    <ul>
      ...
      <li>
        ...
        <figure>
          <img
            src="lessons/asteroids/ryggsekk.png"
            alt="Bilde av hvordan dra romskip-kopien fra ryggsekken i Scratch"
          />
        </figure>
        <p>
          ...
          om du har et <code>Sjekk landing</code>-skript trenger vi ikke det i
          dette spillet.
        </p>
      </li>
      <li>
      ...
      <li>
        ...
        <p>
          Dette gjør vi ved ganske enkle
          <code class="blockcontrol">hvis</code>-tester. Det vi må huske på er
          at <code>x</code>-koordinatene på skjermen går fra
          <code>-240</code> til <code>240</code>, mens
          <code>y</code>-koordinatene ligger mellom <code>-180</code> og
          <code>180</code>. Siden Scratch passer på at figurer ikke går helt av
          skjermen flytter vi dem litt innenfor skjermkanten:
        </p>
...
<section class="activity">
  <h1 class="activity" id="steg-2%3A-romskipet-kan-skyte">
    Steg 2: Romskipet kan skyte
  </h1>
  <p>
    <em
      >Romskipet vårt vil snart fly inn i en asteroidesverm, så vi må montere
      raketter som kan sprenge unna asteroidene.</em
    >
  </p>
  <section class="check">
    ...
    <ul>
      <li>
        <p>
          ...
          skal bli passe stor. Legg også på en kloss for å
          <code class="blocklooks">skjule</code> figuren.
        </p>
      </li>
      <li>
        <p>
        ...
        <p>
          ...
          <code>Nytt spill</code>-meldingen. Skriptet kan bestå av en
          <code class="blockcontrol">gjenta for alltid</code>-løkke, hvor du
          tester på om mellomromtasten er trykket. Dersom et skudd skal avfyres
          kan du først la skuddet
          <code class="blockmotion">gå til</code> romskipet og deretter peke i
          samme retning som romskipet. Dette siste kan du gjøre med en
          kombinasjon av <code class="blockmotion">pek i retning</code>,
          <code class="blocksensing">retning av</code> og
          <code class="blockmotion">vend</code>-klosser. Til slutt kan du
          <code class="blockcontrol">lage en klon</code> av figuren.
        </p>
      </li>
      <li>
        <p>
...
slutt
      ...
      <li>
        <p>
          ...
          rekkevidden på skuddet ved å endre på hvor mange ganger løkka gjentas
          og hvor mange steg figuren går inne i løkka.
        </p>
      </li>
      <li>
        <p>
        ...
        <p>
          Kopier koden for å <em>warp'e</em> rundt skjermen fra romskipet til
          skudd-figuren.
        </p>
      </li>
      <li>
...
<section class="activity">
  <h1 class="activity" id="steg-3%3A-pass-deg-for-asteroidene">
    Steg 3: Pass deg for asteroidene
  </h1>
  <p>
    <em
      >Da er det på tide å lage en asteroidesverm. Noe av det som er kult med
      Asteroids er at asteroidene blir skutt i småbiter når de treffes, og man
      må fortsatt passe seg for og skyte disse mindre asteroidene. Vi vil kode
      dette ved å bruke kloner i forskjellige størrelser.</em
    >
  </p>
  <section class="check">
    ...
    <ul>
      <li>
        ...
        <figure>
          <img
            src="lessons/asteroids/flyttpunkt.png"
            alt="Bilde av en astroidefigur i Scratch"
          />
        </figure>
      </li>
      <li>
      ...
      <li>
        <p>
          ...
          <code class="blocksensing">berører romskipet</code>. Inne i løkken lar
          du først asteroiden <code class="blockmotion">gå noen steg</code>.
          Deretter må du teste om asteroiden
          <code class="blocksensing">berører et skudd</code>. Hvis den gjør det
          kan du lage asteroiden mindre med en kloss som ligner
        </p>
        <pre><code class="blocks">sett størrelse til ((størrelse) / (2)) %
</code></pre>
        <p>
          <code class="blockcontrol">Hvis</code>
          <code class="blocklooks">størrelsen</code> fortsatt er større enn for
          eksempel 10 kan du lage et par nye kloner av denne mindre asteroiden.
          Til slutt kan du
          <code class="blockcontrol">slette denne klonen</code> uansett hva
          størrelsen er.
        </p>
      </li>
      <li>
  ...
  <section class="check">
    ...
    <ul>
      <li>
        ...
        <pre><code class="blocks">avrund ((100) / (størrelse))
</code></pre>
      </li>
      <li>
        <p>
          ...
          <code class="blockmotion">gå til romskipet</code>, men deretter peke i
          en tilfeldig retning og
          <code class="blockmotion">gå 100 til 200 steg</code> før det til slutt
          <code class="blocklooks">vises</code>.
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        ...
        <p>
          ...
          mange asteroider som flyr rundt. Lag derfor en variabel
          <code class="blockdata">Antall asteroider</code> som du øker med 1 når
          en asteroide <code class="blockcontrol">starter som klon</code>.
          Deretter må variabelen minke med 1 når klonen slettes.
        </p>
        <p>
          Videre bruker du en <code class="blockdata">Nivå</code>-variabel som
          holder styr på hvilket nivå spilleren har kommet til.
        </p>
      </li>
      <li>
        <p>
