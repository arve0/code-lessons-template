...
<section class="intro">
  ...
  <p>
    Scratch er et grafisk programmeringsspråk utviklet spesielt for at barn og
    unge enkelt skal lære seg programmering. Denne veiledningen viser hvordan du
    kan holde et kodekurs eller en skoletime hvor elevene møter Scratch for
    første gang.
  </p>
  <figure>
    <img
      src="lessons/veiledning_kom_i_gang/kom_i_gang_med_scratch.png"
      alt="Bilde av programmet Scratch"
    />
  </figure>
</section>
<section class="activity">
  <h1 class="activity" id="f%C3%B8r-kurset">Før kurset</h1>
  <p>
    Scratch krever ikke at du har mye programmeringserfaring selv for å veilede.
    Miljøet er laget for at det skal være raskt og enkelt for barna å komme i
    gang, og
    <a href="lessons/veiledning_kom_i_gang/../">introduksjonsoppgavene</a>
    hjelper barna å lære selvstendig. Nedenfor er en sjekkliste med
    forberedelser det likevel er nyttig å gå gjennom før kodekurset.
  </p>
  <section class="check">
    ...
    <ul>
      <li>
        ...
        <figure>
          <img
            src="lessons/veiledning_kom_i_gang/larerveiledning.png"
            alt="Bilde av hvor lærerveiledningen kan finnes"
          />
        </figure>
        <p>
      ...
      <li>
        <p>
          ...
          oppgavene uten å skrive dem ut ved at barna har oppgaveteksten åpen i
          en egen fane i nettleseren. Men dette skaper ekstra komplikasjoner ved
          at de stadig må bytte faner, huske det de leser osv. Vi anbefaler
          derfor at du skriver ut oppgavene, ihvertfall de første gangene til
          barna blir mer erfarne med å bruke Scratch.
        </p>
        <p>
        ...
        <figure>
          <img
            src="lessons/veiledning_kom_i_gang/last_ned_pdf.png"
            alt="Bilde av hvordan laste ned PDF"
          />
        </figure>
      </li>
      <li>
        <p>
          ...
          <em>datamaskiner</em> å følge opp og barna vil naturlig hjelpe
          hverandre mer.
        </p>
      </li>
      <li>
      ...
      <li>
        <p>
          Scratch kjøres i nettleseren og er derfor i utgangspunktet avhengig av
          at alle har nettilgang. Dersom du ikke er 100% trygg på at alle barna
          vil komme seg på nett bør du ha
        ...
        <p>
          Du bør forberede en minnepenn hvor du på forhånd har lastet ned Adobe
          Air og Scratch offline for de forskjellige operativsystemene.
        </p>
      </li>
    </ul>
  </section>
...
<section class="activity">
  <h1 class="activity" id="opprett-brukere">Opprett brukere</h1>
  <p>
    Det første du bør gjøre på selve kodekurset er å la alle barna opprette
    brukere. Det er strengt tatt ikke nødvendig å ha en scratchbruker for å
    programmere Scratch, men brukeren åpner en del fordeler som at det blir
    enklere å lagre prosjektet sitt, prosjektet blir tilgjengelig på alle
    datamaskiner osv.
  </p>
  <section class="check">
    ...
    <ul>
      <li>
        <p>
          ...
          <a href="https://scratch.mit.edu/scratch2download/"
            >Scratch offline</a
          >
          trenger de ikke opprette scratchbruker.
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        ...
        <p>
          ...
          behjelpelig med å la de bruke din e-postadresse (aller helst oppretter
          du en egen adresse til dette formålet). Klikk i såfall gjennom
          e-postene du får i etterkant av kurset, og bekreft kontoene.
        </p>
      </li>
    </ul>
  </section>
...
<section class="activity">
  <h1 class="activity" id="introduser-scratchmilj%C3%B8et">
    Introduser Scratchmiljøet
  </h1>
  <p>
    Etter at alle barna har opprettet sine brukere bør du introdusere
    Scratchmiljøet gjennom en kort presentasjon i fellesskap. Denne trenger ikke
    ta mer enn rundt 5 minutter, slik at barna får mest mulig tid til å prøve på
    egenhånd.
  </p>
  <p>
    Under er et eksempel på en presentasjon som introduserer de viktigste
    elementene i Scratchmiljøet, og er mer enn nok til at barna kommer i gang på
    egenhånd. Alternativt, kan du også jobbe gjennom første steg i oppgaven
    sammen med barna.
  </p>
  <section class="check">
    ...
    <ul>
      ...
      <li>
        ...
        <figure>
          <img
            src="lessons/veiledning_kom_i_gang/velg_sprak.png"
            alt="Bilde av hvordan velge riktig språk i Scratch"
          />
        </figure>
      </li>
      <li>
        ...
        <ul>
          <li>
            <p>
              <strong>Scenen</strong> øverst til venstre er der ting vil skje.
              Snart skal vi fortelle katten at den skal flytte på seg!
            </p>
          </li>
          <li>
            <p>
              <strong>Figurlisten</strong> under scenen viser figurene i
              programmet vårt. Etterhvert vil vi ha flere figurer enn katten.
            </p>
          </li>
          <li>
            <p>
              <strong>Kodevinduet</strong> til høyre, inkludert listen over
              klosser i midten, er der selve programmeringen skjer.
            </p>
          </li>
        </ul>
      </li>
      ...
      <li>
        <p>
          ...
          deretter også <code class="b">vend høyre (15) grader</code>-klossen
          til høyre, og fest den under den første klossen slik:
        </p>
...
vend høyre (15) grader
        ...
        <p>
          ...
          roterer.
          <em>Vi har laget et skript som gir to kommandoer til katten!</em>
        </p>
        <p>
          I Scratch kaller vi en slik samling kodeklosser som utføres sammen for
          et <em>skript</em>. Alle skriptene i et prosjekt utgjør tilsammen et
          <em>program</em>.
        </p>
      </li>
      <li>
      ...
      <li>
        ...
        <p>
          Gå til <code class="blocklooks">Utseende</code>-kategorien, og klikk
          på klossen <code class="b">endre [farge v] effekt med (25)</code>. Vis
          hvordan katten endrer farge. Legg denne klossen øverst i skriptet
          ditt, slik at det ser ut som følger:
        </p>
        <pre><code class="blocks">endre [farge v] effekt med (25)
gå (20) steg
vend høyre (15) grader
</code></pre>
      </li>
...
pek mot [musepeker v]
      ...
      <li>
        ...
        <p>
          ...
          ut en <code class="b">for alltid</code>-kloss slik at den legger seg
          rundt skriptet ditt.
        </p>
...
slutt
        ...
        <p>Før du klikker på skriptet, spør barna hva de tror vil skje!</p>
      </li>
      <li>
        <p>
    ...
    <p>
      ...
      <code>Programmering</code> for å prøve selv. Ofte vil de teste ut noe av
      det du viste dem i presentasjonen. La dem gjerne gjøre dette et par
      minutter før du minner dem på oppgaven, og ber dem begynne å jobbe med
      den.
    </p>
  </section>
</section>
<section class="activity">
  <h1 class="activity" id="etter-kurset">Etter kurset</h1>
  <p>
    Det er etterhvert mange barn, kodeklubber og skoler som bruker oppgavene og
    veiledningene her på
    <a href="lessons/veiledning_kom_i_gang/../../">kodeklubben.github.io</a>.
    Dersom du oppdager feil eller har forslag til forbedringer på noen av sidene
    er det derfor veldig nyttig om du melder fra om dette.
  </p>
  <p>
    På alle sider - oppgaver og veiledninger - er det en
    <code>Rapporter et problem</code>-knapp nederst som du kan trykke for å
    sende oss en tilbakemelding. Bruk denne! Vi er veldig takknemlige for alle
