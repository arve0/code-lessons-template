<!-- generated from src/lessons/breakout/breakout.md -->
...
<section class="intro">
  ...
  <p>
    ...
    Wozniak (grunnleggerene av Apple) på 1970-tallet. På samme måte som i Pong
    skal man kontrollere en sprettende ball ved hjelp av en racket. Men Breakout
    kan spilles av en spiller hvor man får poeng for å skyte ned bokser ved
    hjelp av ballen. Nyere versjoner har videreutviklet Breakout på flere måter.
    For eksempel ved at noen bokser gir spesielle bonuser, ved at det finnes
    forskjellige brett av ulik vanskelighetsgrad og så videre.
  </p>
  <figure>
    <img
      src="lessons/breakout/breakout.png"
      alt="Illustrasjon av et ferdig Breakout spill"
    />
  </figure>
</section>
<section class="activity">
  ...
  <p>
    <em
      ...
      racketen og ballen ligner en del på den tilsvarende koden i Pong. Vi vil
      derfor fokusere på boksene i dette prosjektet, og spesielt diskutere
      hvordan man kan bruke kloner på en effektiv måte.</em
    >
  </p>
  <section class="check">
...
<section class="activity">
  <h1 class="activity" id="steg-1%3A-bokser-...-mange-bokser!">
    Steg 1: Bokser ... Mange bokser!
  </h1>
  <p>
    <em
      >En sentral del av Breakout er alle boksene man skal prøve å skyte ned.
      Siden disse boksene alle oppfører seg (nesten) likt vil vi bruke den samme
      koden for alle boksene. Til dette bruker vi kloning.</em
    >
  </p>
  <p>
    I Scratch kan vi klone figurer. Det betyr at vi lager en kopi av en figur,
    både av utseendet og oppførselen. Her vil vi derfor først lage en boks, og
    deretter lage mange kopier av denne.
  </p>
  <section class="check">
...
<section class="activity">
  <h1 class="activity" id="steg-2%3A-en-sprettende-ball-og-en-enkel-racket">
    Steg 2: En sprettende ball og en enkel racket
  </h1>
  <p>
    <em
      >Når man lager nye programmer og spill er det alltid lurt å lage en enkel
      versjon av spillet tidlig. Denne tidlige versjonen behøver ikke kunne
      gjøre veldig mye, du kan likevel begynne å teste at programmet blir som du
      hadde tenkt nesten med en gang.</em
    >
  </p>
  <p>
    Vi begynner nå med grunnmekanismen i spillet: En ball som spretter og en
    racket som kan ta i mot ballen.
  </p>
  <section class="check">
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          <code>Pil høyre</code>-tastene trykkes.
        </p>
      </li>
      <li>
        <p>
...
<section class="activity">
  <h1 class="activity" id="steg-3%3A-boksene-forsvinner">
    Steg 3: Boksene forsvinner
  </h1>
  <p>
    <em
      >Vi skal nå koble sammen boksene og ballen. Boksene skal jo forsvinne når
      de blir truffet av ballen. Samtidig skal ballen sprette når den treffer en
      boks.</em
    >
  </p>
  <section class="check">
    ...
    <ul>
      ...
      <li>
        ...
        <p>
          ...
          forskjellige boksene som forskjellige drakter. Deretter kan du lage en
          <code class="blockdata">brett</code>-variabel som lister opp hvilken
          drakt hver boks skal bruke. For eksempel kan denne se slik ut:
        </p>
        <pre><code class="blocks">sett [brett v] til [1111111111111222222211112233322111122222221111111111111]
</code></pre>
        <p>Denne kan så brukes når du setter ut boksene omtrent som dette:</p>
        <pre><code class="blocks">bytt drakt til (bokstav (antall bokser) i (brett))
</code></pre>
        <p>
          Videre i spillet kan du teste på
          <code class="blocklooks">drakt nr.</code> for å vite hvilken type boks
          du har med å gjøre.
        </p>
      </li>
    </ul>
