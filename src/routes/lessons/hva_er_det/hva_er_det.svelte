...
<section class="intro">
  ...
  <p>
    Et bilde av en tilfeldig ting vises på tavlen. Men bildet er forvrengt, slik
    at du må gjette hva det er ved å klikke på et av alternativene som vises
    under. Desto raskere du gjetter riktig, desto flere poeng får du.
  </p>
  <figure>
    <img
      src="lessons/hva_er_det/hva_er_det.png"
      alt="Illustrasjon av et ferdig hva-er-det spill"
    />
  </figure>
</section>
<section class="activity">
  <h1
    class="activity"
    id="steg-1%3A-f%C3%A5-flere-ting-til-%C3%A5-vise-seg-p%C3%A5-tavlen"
  >
    Steg 1: Få flere ting til å vise seg på tavlen
  </h1>
  <p><em>Vi vil at noen forskjellige bilder skal komme opp på tavlen.</em></p>
  <section class="check">
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          />
          og velg så <code>Innendørs/chalkboard</code>.
        </p>
      </li>
      <li>
        <p>
...
bytt drakt til (tilfeldig tall fra (1) til (5))
  ...
  <section class="flag">
    ...
    <p>
      Det gjør ingenting om samme drakt kommer opp flere ganger på rad. Det er
      helt normalt når det velges en tilfeldig drakt hver gang.
    </p>
  </section>
</section>
<section class="activity">
  <h1 class="activity" id="steg-2%3A-forvreng-bildet">
  ...
  <p>
    Vi skal bruke en <code class="blockdata">poeng</code>-variabel til å
    kontrollere graden av forvrenging. Dersom poengscoren er høy vil bildet bli
    veldig forvrengt. Når antallet poeng synker, vil også graden av forvrenging
...
<section class="activity">
  <h1
    class="activity"
    id="steg-3%3A-la-spilleren-pr%C3%B8ve-%C3%A5-gjette-bildet"
  >
    Steg 3: La spilleren prøve å gjette bildet
  </h1>
  <p>
    Så langt har vi fått vårt tilfeldige bilde til å gradvis bli tydeligere
    samtidig som poengsummen synker. Men hvordan skal man vinne spillet? Vi vil
    legge til noen figurer nederst på skjermen som spilleren kan klikke på.
    Klikker man på den rette, vinner man spillet. Klikker man feil forsvinner
    figuren og spillet fortsetter.
  </p>
    ...
    <ul>
      ...
      <li>
        ...
        <p>
          ...
          viser en drakt som hovedfiguren kan ha. Ingen av
          <code>Svar</code>-figurene skal ha skript knyttet til seg.
        </p>
      </li>
      <li>
        <p>
...
slutt
      ...
      <li>
        ...
        <pre><code class="blocks">når jeg mottar [Vant v]
si (sett sammen [Gratulerer! Din poengsum ble ] (poeng))
  ...
  <section class="flag">
    ...
    <p><strong>Klikk på det grønne flagget.</strong></p>
    <p>
      Når du tester spillet kan du se på spørsmålsfiguren under scenen for å se
      hva riktig svar er. Det fungerer bra for testing.
    </p>
    <ul>
      <li>
  ...
  <section class="check">
    ...
    <p>
      Denne testen viser oss <strong>to problemer</strong>: Først og fremst,
      ting som ble klikket på ved galt svar kommer ikke tilbake når et nytt
      spill starter. For det andre, poengsummen fortsetter å gå ned, også etter
...
vis
    ...
    <p>
      ...
      <code class="blockcontrol">gjenta til</code>-løkke når spilleren klikker
      på riktig svar. Vi kan bruke en ny variabel for å gjøre det. Vi vil kalle
      denne variabelen <code class="blockdata">vant</code> og legger inn en
      <code class="blockdata">sett</code>-kloss som gir den verdien
      <code>0</code> når spillet starter, og en tilsvarende kloss som setter
      verdien til <code>1</code> når spillet vinnes. Se skriptene nedenfor.
    </p>
    <ul>
      <li>
        <p>
...
si (sett sammen [Gratulerer! Din poengsum ble] (poeng))
  ...
  <section class="save">
    ...
    <p><strong>Gratulerer! Du er nå ferdig med spillet.</strong></p>
    <p>
      Men det finnes mange flere ting du kan gjøre med spillet. Prøv deg gjerne
      på utfordringene nedenfor!
    </p>
  </section>
  <section class="challenge">
    <h2
      class="challenge"
      id="utfordring-1%3A-gj%C3%B8r-spillet-enklere-eller-vanskeligere"
    >
    ...
    <ul>
      <li>
        <p>
          Forsøk å endre hvor lenge bildet vises frem og hvor raskt poengsummen
          minker.
        </p>
      </li>
      <li>
        <p>Forsøk å endre forvrengingen av bildet.</p>
      </li>
      <li>
        <p>
  ...
  <section class="challenge">
    <h2
      class="challenge"
      id="utfordring-2%3A-forvreng-bildet-ulikt-fra-gang-til-gang"
    >
      Utfordring 2: Forvreng bildet ulikt fra gang til gang
    </h2>
    <p>
      For øyeblikket bruker spillet samme forvrengingsalgoritme hele tiden. Men
      i steg 2 prøvde du kanskje ut noen forskjellige alternativer. Prøv nå om
      du kan finne noen flere forvrenginger som du synes fungerer like bra som
      <code>farge</code> og <code>piksler</code>.
    </p>
    <p>
    ...
    <p>
      <strong>Hint:</strong> Forsøk å opprette en ny variabel som du kaller
      <code>forvrenging</code>. Sett denne til en tilfeldig verdi i starten av
      spillet. Bruk så <code class="blockcontrol">hvis</code>-klosser i
      <code class="blockcontrol">gjenta til</code>-løkken for å velge ut en
      forvrenging til hvert spill.
    </p>
  </section>
  <section class="challenge">
    <h2 class="challenge" id="utfordring-3%3A-la-hvert-spill-ha-flere-runder">
      Utfordring 3: La hvert spill ha flere runder
    </h2>
    <p>
      For øyeblikket er hvert spill uavhengig av andre. Prøv om du kan legge til
      flere runder slik at man får gjette på for eksempel tre ting og kan vinne
      inntil 300 poeng.
    </p>
    <p>
      <strong>Hint:</strong> Du vil trenge en ekstra variabel for å lagre den
      totale poengsummen. Du må også ha en løkke som går rundt for hver runde.
    </p>
  </section>
  <section class="challenge">
    <h2
      class="challenge"
      id="utfordring-4%3A-%C3%B8k-vanskelighetsgraden-gradvis"
    >
      Utfordring 4: Øk vanskelighetsgraden gradvis
    </h2>
    <p>Gjør nå spillet vanskeligere og vanskeligere for hver runde.</p>
    <p>
      Kanskje hver runde også skal gi ulikt antall poeng? Bør spilleren også få
      ekstra mange poeng for å gjette kjapt i de vanskeligste rundene?
    </p>
    <p>
      <strong>Hint:</strong> Hvordan kan du vite hvilken runde du er i? Hvordan
      kan du bruke det til å endre vanskelighetsgraden og poengsummen?
    </p>
  </section>
  <section class="challenge">
    <h2
      class="challenge"
      id="utfordring-5%3A-fortsett-til-spilleren-gj%C3%B8r-feil"
    >
      Utfordring 5: Fortsett til spilleren gjør feil
    </h2>
    <p>
      I stedet for et bestemt antall runder kan du la spillet gå til det blir
      klikket på feil svar. Dette fungerer nok best dersom man også øker
      vanskelighetsgraden utover i spillet.
    </p>
  </section>
  <section class="challenge">
    <h2
      class="challenge"
      id="utfordring-6%3A-tilpass-spillet-til-hvor-flink-spilleren-er"
    >
      Utfordring 6: Tilpass spillet til hvor flink spilleren er
    </h2>
    <p>
      I stedet for å gjøre det stadig vanskeligere kan vi tilpasse
      vanskelighetsgraden til spillernes dyktighet. Hvis de raskt gjetter riktig
      ting, kan den neste runden gjøres vanskeligere. Hvis de klikker feil eller
      gjetter sakte, kan neste runde gjøres enklere.
    </p>
    <p>
  ...
  <section class="challenge">
    <h2 class="challenge" id="utfordring-7%3A-hold-styr-p%C3%A5-rekorden">
      Utfordring 7: Hold styr på rekorden
    </h2>
    <p>
      Finn en måte å lagre den høyeste poengsummen på. Klarer du også å lagre
      navnet til spilleren, og få spillet til å si hvem som har rekorden?
    </p>
  </section>
  <section class="challenge">
    <h2 class="challenge" id="utfordring-8%3A-gi-en-straff-for-galt-svar">
      Utfordring 8: Gi en straff for galt svar
    </h2>
    <p>
      Slik spillet er nå kan man bare klikke som en gal på alle svarene, og
      dermed raskt finne riktig svar. Det kan derfor være en god idé å trekke
      fra poeng hver gang spilleren klikker på feil figur.
    </p>
  ...
  <section class="save">
    ...
    <p>
      <strong
        >Veldig bra! Nå er du ferdig og kan spille det nye spillet du har
        laget!</strong
      >
    </p>
    <p>
