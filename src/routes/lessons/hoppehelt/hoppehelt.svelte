...
<section class="intro">
  ...
  <p>
    Hoppehelt er litt inspirert av musikkspillet Guitar Hero. I Hoppehelt skal
    man kontrollere flere helter samtidig mens de hopper over fargede bokser som
    lager lyd. Gjennom spillet Hoppehelt vil vi se litt nærmere på hvordan
    kloner brukes når man programmerer i Scratch. Vi vil til og med se eksempler
    på kloner av kloner!
  </p>
  <figure>
    <img
      src="lessons/hoppehelt/hoppehelt.png"
      alt="Illustrasjon av et ferdig hoppehelt spill"
    />
  </figure>
</section>
<section class="activity">
  <h1 class="activity" id="steg-1%3A-streken">Steg 1: Streken</h1>
  <p><em>Vi begynner spillet vårt ved å lage en veldig enkel bakgrunn.</em></p>
  <section class="check">
...
<section class="activity">
  <h1 class="activity" id="steg-2%3A-en-hoppende-helt">
    Steg 2: En hoppende helt
  </h1>
  <p><em>Nå skal vi introdusere hoppehelten.</em></p>
  <section class="check">
    ...
    <ul>
      <li>
        ...
        <p>
          Du kan senere lage flere drakter slik at spillet ser bedre ut, men vi
          vil ikke bruke tid på det nå.
        </p>
      </li>
      <li>
        <p>
        ...
        <p>
          Vi vil bruke <code class="blockdata">sprett</code>-variabelen til å
          beskrive heltens bevegelse når han hopper.
        </p>
      </li>
      <li>
        <p>
...
slutt
        ...
        <p>
          Sett fargen i <code class="blocksensing">berører fargen</code>-klossen
          til samme farge som streken du tegnet på bakgrunnen i Steg 1.
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>
          ...
          fram slik at du finner en verdi som gjør at helten gjør passe store
          hopp.
        </p>
      </li>
    </ul>
...
<section class="activity">
  <h1 class="activity" id="steg-3%3A-bokser-med-lyd">Steg 3: Bokser med lyd</h1>
  <p><em>Vi skal nå lage noen bokser som helten kan hoppe over.</em></p>
  <section class="check">
    ...
    <ul>
      <li>
        <p>
          ...
          til helten berører <code>Boks</code>.
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        ...
        <p>
          kloss etter løkken som flytter boksen, men før klonen slettes. Bruk
          gjerne <code class="blocksound">velg instrument</code>-klossen til å
  ...
  <section class="challenge">
    ...
    <p>
      Før vi går videre skal vi se på et par måter vi kan gjøre hver enkelt boks
      litt spesiell og forskjellig fra de andre på. Prøv å eksperimentere med
      disse og de andre innstillingene i spillet ditt.
    </p>
    <p>
      Helt først i skriptet hvor boksen starter som klon, før den vises, kan du
      prøve noe av det følgende. Du kan endre størrelsen på boksen tilfeldig,
      for eksempel med klossen
    </p>
    <pre><code class="blocks">sett størrelse til (tilfeldig tall fra (30) til (100)) %
</code></pre>
    <p>På samme måte kan du bruke</p>
    <pre><code class="blocks">sett [farge v] effekt til (tilfeldig tall fra (-100) til (100))
</code></pre>
    <p>
    ...
    <p>
      Prøv tilslutt å endre på hvor ofte det dukker opp nye bokser. Bruk gjerne
      en
    </p>
    <pre><code class="blocks">tilfeldig tall fra (1.2) til (3.2)
</code></pre>
    <p>kloss. Eksperimenter med verdiene i klossen.</p>
  </section>
</section>
<section class="activity">
  <h1 class="activity" id="steg-4%3A-flere-streker-og-bokser">
    ...
    <ul>
      <li>
        <p>
          ...
          Videre har du en <em>flytte-løkke</em> som flytter boksene mot høyre,
          med eventuelle tilfeldige innstillinger på boksene.
        </p>
        <p>
          Riv løs begge disse to løkkene og legg dem til side. Vi skal bruke dem
          igjen straks, så ikke slett noe.
        </p>
      </li>
      <li>
        <p>
...
slutt
        ...
        <p>
          ...
          <em>generator-kloner</em> med forskjellige y-verdier.
        </p>
      </li>
      <li>
        <p>
...
<section class="activity">
  <h1 class="activity" id="steg-5%3A-hvor-er-alle-heltene%3F">
    Steg 5: Hvor er alle heltene?
  </h1>
  <p><em>Vi skal nå lage de siste to hoppeheltene!</em></p>
  <section class="check">
    ...
    <ul>
      ...
      <li>
        ...
        <p>
          Endre y-posisjonen i <code class="blockmotion">gå til</code>-klossen
          med 110.
        </p>
        <p>
          Endre <code>m</code> til <code>k</code> i
          <code class="blocksensing">tast trykket</code>-testen.
        </p>
      </li>
    </ul>
    <p>
  ...
  <section class="challenge">
    ...
    <p>
      Oppgaven slutter her, men det er jo fortsatt mange spennende ting du kan
      gjøre med spillet ditt for å gjøre det enda bedre.
    </p>
    <p>
      Prøv for eksempel å legge til poeng ved å lage en
      <code class="blockdata">Poeng</code>-variabel som du øker hver gang en
      boks har blitt hoppet over. Du kan også øke hastigheten etterhvert som
      spillet går.
    </p>
    <p>
      Prøv å gjøre tonen som spilles avhengig av y-posisjonen til boksen. Dette
      er litt vanskelig, men blir veldig kult da det høres ut hoppeheltene
      spiller en liten sang ved å hoppe over boksene.
    </p>
  </section>
</section>
