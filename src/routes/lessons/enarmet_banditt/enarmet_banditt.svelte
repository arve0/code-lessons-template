...
<section class="intro">
  ...
  <p>
    Dette er et spill med tre figurer som endrer utseende. Din oppgave er å
    stoppe figurene én etter én, slik at alle tre blir like.
  </p>
  <figure>
    <img
      src="lessons/enarmet_banditt/enarmet_banditt.png"
      alt="Bilde av to dinosaurer og en banan"
    />
  </figure>
</section>
<section class="activity">
  <h1 class="activity" id="steg-1%3A-lag-en-figur-som-bytter-drakt">
    Steg 1: Lag en figur som bytter drakt
  </h1>
  <p><em>La oss importere de bildene vi trenger for spillet.</em></p>
  <section class="check">
...
<section class="activity">
  <h1 class="activity" id="steg-2%3A-f%C3%A5-figuren-til-%C3%A5-rullere">
...
slutt
  ...
  <section class="challenge">
    ...
    <p>
      Tilpass tiden i <code class="blockcontrol">vent</code>-klossen. Hvilke
      tall gjør spillet for vanskelig eller for lett?
    </p>
  </section>
</section>
<section class="activity">
  <h1 class="activity" id="steg-3%3A-frys-ruletten!">Steg 3: Frys ruletten!</h1>
  <p>
    <em
  ...
  <section class="check">
    ...
    <p>
      Bra! Vi kan få draktene til å bytte i det uendelige, men hvordan får vi de
      til å stoppe når vi klikker på de? En måte å gjøre dette på er ved å bruke
      en variabel som setter statusen til figuren. Dette vil vi se at er
      praktisk også senere.
    </p>
    <ul>
      <li>
        <p>
...
sett [stoppet v] til [1]
      ...
      <li>
        <p>
          ...
          <code class="blockdata">stoppet</code> fremdeles er <code>0</code>.
        </p>
        <pre><code class="blocks">når @greenFlag klikkes
sett [stoppet v] til (0)
gjenta for alltid
...
slutt
  ...
  <section class="flag">
    ...
    <p>
      <strong
        >Start skriptet en gang til ved å klikke på det grønne flagget
        igjen.</strong
      >
    </p>
    <ul>
...
<section class="activity">
  <h1 class="activity" id="steg-4%3A-lag-de-andre-figurene">
    Steg 4: Lag de andre figurene
  </h1>
  <p><em>Nå trenger vi to figurer til for å gjøre spillet komplett!</em></p>
  <section class="check">
...
<section class="activity">
  <h1 class="activity" id="steg-5%3A-start-hver-figur-med-en-tilfeldig-drakt">
...
slutt
  ...
  <section class="challenge">
    ...
    <p><strong>Gjør spillet vanskeligere!</strong></p>
    <p>
      Se om du klarer å endre vanskelighetsgraden på et eller annet vis. Å få
      draktene til å rullere raskere er enkelt. Prøv å gjøre noe litt mer
    ...
    <p>
      ...
      vanskeligere. Er spillet for lett eller for vanskelig? Hvordan kan du
      justere det slik at det blir akkurat passe?
    </p>
  </section>
</section>
<section class="activity">
  <h1 class="activity" id="steg-6%3A-vis-en-melding-n%C3%A5r-spillet-er-over">
    Steg 6: Vis en melding når spillet er over
  </h1>
  <p>
    <em
      >La oss vise en <code>Spillet er slutt</code>-melding når spillet er
      over.</em
    >
  </p>
  <section class="check">
    <h2 class="check" id="sjekkliste-6">Sjekkliste</h2>
    <p>La oss først hente en ny bakgrunn som vi viser når spillet er over.</p>
    <ul>
      <li>
        <p>
      ...
      <li>
        <p>
          ...
          bruker vi en
          <code class="blocksensing">x-posisjon av Figur3</code>-kloss fra
          <code class="blocksensing">Sansning</code>, men hvor vi bytter ut
          <code>x-posisjon</code> med <code>stoppet</code>.
        </p>
        <pre><code class="blocks">når @greenFlag klikkes
    ...
    <ul>
      <li>
        <p>
          ...
          komplisert kloss som kan være litt trøblete å lage, så forsøk å gjøre
          ett steg av gangen. Legg merke til at vi har satt sammen to
          <code class="b">&lt;&lt;&gt; og &lt;&gt;&gt;</code>-klosser, tre
          <code class="b">&lt;() = ()&gt;</code>-klosser og tre
          <code class="blocksensing">stoppet av Figur</code>-klosser.
        </p>
        <pre><code class="blocks">når @greenFlag klikkes
bytt bakgrunn til [Spill v]
...
<section class="activity">
  <h1 class="activity" id="steg-7.-fortell-spilleren-om-de-vant-eller-tapte.">
    Steg 7. Fortell spilleren om de vant eller tapte.
  </h1>
  <p>
    <em
      >Målet med spillet er å klikke på figurene slik at de stopper når de viser
      samme drakten. Det ville være praktisk å vise en melding som forteller deg
      om du vant eller tapte.</em
    >
  </p>
  <section class="check">
    <h2 class="check" id="sjekkliste-8">Sjekkliste</h2>
    <p>
      Vi har tidligere skrevet kode som sjekker om spillet er over, så alt vi
      trenger å gjøre er å sjekke om spilleren har vunnet.
    </p>
    <ul>
      <li>
        <p>
    ...
    <p>
      Nå trenger vi kode for å velge hvilken bakgrunn vi skal vise når spillet
      er over.
    </p>
    <ul>
      <li>
        <p>
          ...
          <code class="blockdata">stoppet</code>-variabelen, skal vi sjekke
          <code>drakt nr.</code> og se om <code>Figur1</code> har samme drakt
          som <code>Figur2</code> og om <code>Figur2</code> har samme drakt som
          <code>Figur3</code>.
        </p>
        <pre><code class="blocks">når @greenFlag klikkes
bytt bakgrunn til [Spill v]
...
slutt
  ...
  <section class="flag">
    ...
    <p>
      <strong>Veldig bra!</strong> Du har nå fullført spillet, men det er
      fremdeles ting du kan gjøre med spillet ditt. Prøv deg på disse
      utfordringene!
    </p>
  </section>
  <section class="challenge">
    <h2
      class="challenge"
      id="utfordring%3A-gj%C3%B8r-spillet-enklere-og-vanskeligere-med-tiden"
    >
      Utfordring: Gjør spillet enklere og vanskeligere med tiden
    </h2>
    <p>
      Alle er ikke like flinke til spillet. Hvordan kan du la
      vanskelighetsgraden <strong>avhenge av spilleren?</strong>
    </p>
    <p>
      En måte å gjøre dette på er å
      <strong>endre hastigheten draktene forandres på</strong>. Du kan bruke en
      variabel kalt <code class="blockdata">forsinkelse</code> for å gi
      varigheten til hver figurs ventekloss. Hvis spilleren vinner runden kan
      forsinkelsen reduseres litt (for å gjøre spillet vanskeligere). Hvis
      spilleren taper runden kan man øke forsinkelsen litt for å gjøre spillet
      lettere.
    </p>
    <p>
      Du må sikkert vurdere å bruke en annen måte å starte spillet på istedet
      for å bruke <code class="blockgrey">når @greenFlag klikkes</code>.
