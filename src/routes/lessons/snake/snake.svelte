...
<section class="activity">
  ...
  <section class="check">
    ...
    <ul>
      ...
      <li>
        <p>
          [ ] Lag en boksfigur. Tegn denne selv. Du bør lage den ganske liten
          slik at du får plass til en lang slange på skjermen. Pass også på at
          boksen blir like bred som høy. Et sted mellom <code>10 x 10</code> og
      ...
      <li>
        <p>
          [ ] Vi skal nå lage hovedløkken i spillet. Først setter vi de
          nødvendige variablene, deretter bruker vi en løkke til å lage stadig
          nye slangebokser.
        </p>
...
slett denne klonen
      ...
      <li>
        <p>
          [ ] Prøv spillet ditt. Det kan være greit å lage et skript på scenen
          som sender ut meldingen <code>Nytt spill</code> når det grønne flagget
...
<section class="activity">
  ...
  <section class="check">
    ...
    <ul>
      ...
      <li>
        <p>
          [ ] Du kan markere hodet til slangen ved å lage en ekstra drakt. Lag
          for eksempel en kopi av den boksen du allerede har tegnet, og endre
          fargen på denne. Kall en av draktene <code>hode</code> og den andre
      ...
      <li>
        <p>
          ...
          du for eksempel gjøre ved å utvide testen i
    ...
    <ul>
      <li>
        <p>
          ...
          For eksempel en rød fyllt sirkel som er omtrent
...
<section class="activity">
  ...
  <section class="check">
    ...
    <ul>
      ...
      <li>
        <p>
          [ ] La hastigheten øke etterhvert i spillet. Vanligvis gjør vi dette
          ved å forandre hvor mange steg en figur går. Det kan vi ikke gjøre her
      ...
      <li>
        <p>
          ...
          å plukke opp forskjellige bonusepler underveis. For eksempel kan du ha
      ...
      <li>
        <p>
          [ ] Det trenger jo ikke bare være ett eple om gangen. Om du for
          eksempel lager tre epler i starten av spillet vil det være litt mindre
          leting etter eplene og spillet kan være litt morsommere. Du kan gjøre
          dette ved hjelp av kloning, bare pass på at ikke klonene lager nye
          kloner igjen!
        </p>
      </li>
      <li>
        <p>
          [ ] La eplene flytte seg om det går en viss tid uten at de blir spist.
          For å holde styr på tiden kan du bruke
      ...
      <li>
        <p>
          ...
          eksempel tegne på bakgrunnen i en spesiell farge og deretter undersøke
          om slangen <code class="blocksensing">berører fargen</code>. Du kan
          til og med ha flere brett med dører mellom.
        </p>
      </li>
      <li>
        <p>
