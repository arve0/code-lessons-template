...
Til spillet vårt vil vi behøve to drakter til **King Kong**. En drakt der han
...
- Klikk på kopien og bruk knappen ![speilvend](../bilder/speilvend.png "Speilvend høyre-venstre") i øverste høyre hjørne til å speilvende denne nye
  drakten.
...
- For at `kong` skal merke at han blir truffet av flyene lager vi et nytt
  ...
  Her venter vi 0.5 sekunder både for at fargeeffekten skal synes og for at da
...
- Tell liv! King Kong kan ikke bli truffet av flyene `for alltid`{.blockcontrol}. Legg til en `liv`{.blockdata}-variabel som teller hvor
